    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookedVisits", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BookedVisits_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkersAvailabilities", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedVisits_ClientId",
                table: "BookedVisits",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_BookedVisits_ServiceId",
                table: "BookedVisits",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_BookedVisits_WorkerId",
                table: "BookedVisits",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkersAvailabilities_WorkerId",
