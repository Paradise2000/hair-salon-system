...
namespace projektprogramowanie.Migrations
{
    ...
    [Migration("20230122121854_WorkerAvailabilityIsCancelled")]
    partial class WorkerAvailabilityIsCancelled
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("projekt_programowanie.Entities.BookedVisit", b =>
                {
                    ...
                    b.HasOne("projekt_programowanie.Entities.WorkerAvailability", "WorkerAvailability")
                        .WithMany("BookedVisits")
